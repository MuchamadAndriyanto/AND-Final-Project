 ...
 * Use the [CheckoutBiodataPenumpangFragment.newInstance] factory method to
...
class CheckoutBiodataPenumpangFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CheckoutBiodataPenumpangFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CheckoutBiodataPenumpangFragment().apply {
